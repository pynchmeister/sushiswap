...
describe("KashiSushiMaker", function () {
  before(async function () {
    await prepare(this, ["ZapWizardKashi", "ZapStake", "ZapWizardKashiExploitMock", "ERC20Mock", "UniswapV2Factory", "UniswapV2Pair", "BentoBoxV1", "KashiPairMediumRiskV1", "PeggedOracleV1"])
  })
  ...
  beforeEach(async function () {
    ...
    await deploy(this, [["kashiMaker", this.ZapWizardKashi, [this.factory.address, this.bar.address, this.bento.address, this.sushi.address, this.weth.address, this.factory.pairCodeHash()]]])
    await deploy(this, [["exploiter", this.ZapWizardKashiExploitMock, [this.kashiMaker.address]]])
